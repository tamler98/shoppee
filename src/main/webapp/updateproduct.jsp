...
<head>
    ...
    <link rel="stylesheet" href="../resource/updateproduct.css">
...
<body>
   <%--  <header>
                        ...
                        <form action="">
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="filebutton">Tên sản phẩm</label>
                                    <input type="text" name="name_product" id="product_name" value="${detail.name}" required>
                            </div>
                            <div class="form-group">
    ...
    <form action="update" method="post">
	  <input id="pid" type="text" name="id" value="${detail.id}"><br><br>
	  <label for="lname">Tên</label>
	  <input type="text" name="name" value="${detail.name}"><br><br>
	  <label for="lname">Giá</label>
	  <input type="text"  name="price" value="${detail.price}"><br><br>
